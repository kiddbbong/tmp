...
# parser.add_argument('--checkpoint_path', help='Resume from this checkpoint', default='./checkpoint/checkpoint_step000220000.pth', type=str) # lrw dataset wav2lip nogan load
